// This file is part of the Marten project, http://code.google.com/p/marten
...
static int begin_request_handler(struct mg_connection *conn) {
  ...
  if (!request_info->is_ssl) {
    ...
    // No suitable handler found, mark as not processed. Marten will
